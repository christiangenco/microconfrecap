        ...
        <div className="rounded border border-grey-light mt-6">
          ...
          <div className="p-4">
            ...
            <a
              ...
              className="bg-blue hover:bg-blue-dark w-full font-sans text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline no-underline block text-center"
              target="_blank"
            >
